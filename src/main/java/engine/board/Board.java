...
public class Board implements BoardManager, Serializable {
    ...
    private void move(Marble marble, ArrayList<Cell> fullPath, boolean destroy) throws IllegalDestroyException {
        ...
        if(targetCell.isTrap()) {
            ...
            if (((Game) gameManager).getActivePlayerIndex() == 0) {
                Alert alert = new Alert(Alert.AlertType.WARNING);
                alert.setTitle("Trap cell alert!");
                alert.setHeaderText("Marble got destroyed due to Trap Cell.");
                alert.showAndWait();
            }
        }
