...
public class Standard extends Card {
    ...
    public Standard(String name, String description, int rank, Suit suit, BoardManager boardManager, GameManager gameManager) {
        this(name, description, rank, suit, boardManager, gameManager, CardType.getCardType(name, suit));
    }

    public Standard(String name, String description, int rank, Suit suit, BoardManager boardManager, GameManager gameManager, CardType cardType) {
